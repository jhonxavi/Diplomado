...
if (empty($nombre_docente) || empty($dir_docente) || empty($tel_docente) || empty($email_docente) ||
...
$sentencia = $pdo->prepare("INSERT INTO docentes 
    (nombre_docente, dir_docente, tel_docente, email_docente, genero_docente, fecha_nacimiento_docente, 
    formacion_academica, areas_conocimiento) 
    VALUES (:nombre_docente, :dir_docente, :tel_docente, :email_docente, :genero_docente, 
